...
import styles from './jetCarousel.module.css'
...
export default function JetCarousel() {
  return (
    <>
        <div className="h-56 sm:h-64 xl:h-80 2xl:h-96">
            <Carousel>
                <Image className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" priority src={homeHeaderIMG} width={1671} height={302} alt="..."/>
                <Image className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" priority src={contactHeader} width={1671} height={302} alt="..."/>
                <Image className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" priority src={homeHeaderIMG} width={1671} height={302} alt="..."/>
                <Image className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" priority src={contactHeader} width={1671} height={302} alt="..."/>
                <Image className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" priority src={homeHeaderIMG} width={1671} height={302} alt="..."/>
            </Carousel>
